...
// 2, Adding namespace, class, and global variables
namespace refrigerated_truck
{
    class Program
    {
        ...
        static double baseLat = 63.4305;              // Base position latitude.
        static double baseLon = 10.3951;            // Base position longitude.
        ...
        // From Azure Maps Account:
        static string AzureMapsKey = " ";
        ...
        // 4. The GoToCustomer method for directing a driver to a customer
        ...
        static async void SendTruckTelemetryAsync(Random rand, CancellationToken token)
        {
            while (true)
            {
                ...
                // var telemetryMessageString = JsonConvert.SerializeObjects(telemetryDataPoint);
                // var telemetryMessageString = serialiser.WriteObject(telemetryDataPoint);
